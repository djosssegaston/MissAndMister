...
const NAV_ITEMS = [
  ...
  { to: '/admin/j-serai', label: "J'y serai", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" stroke="currentColor" strokeWidth="1.8"/><path d="M14 2v6h6M16 13H8M16 17H8M10 9H8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg> },
  { to: '/admin/billetterie', label: 'Billetterie', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="2" y="4" width="20" height="16" rx="2" stroke="currentColor" strokeWidth="1.8"/><path d="M2 10h20" stroke="currentColor" strokeWidth="1.8"/><path d="M9 4v16" stroke="currentColor" strokeWidth="1.8" strokeDasharray="3 2"/></svg> },
  { to: '/admin/social-projects', label: "Projets d'Impact", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" stroke="currentColor" strokeWidth="1.8"/><path d="M12 6v6l4 2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/><path d="M7 13c.67 1.13 1.67 2 3 2.5M17 13c-.67 1.13-1.67 2-3 2.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg> },
